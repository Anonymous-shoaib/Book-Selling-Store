...
<?php include '../php/header.php'; ?>
        ...
        <div class="search-for-2">
          <label class="custom-file-upload">
              <a href="admin_dashboard.php">Upload a Book</a>
          </label>
      </div>
    ...
    <div class="carousel-container">
        ...
        <div class="carousel">
            <?php foreach ($books as $book): ?>
                ...
                <form method="post" action="../php/delete_book.php" class="delete-form">
...
<div class="footer-container" style="display: flex;
    ...
    align-items: center;width:30%;padding-left: 30px;">
              <a href="admin_dashboard_1.php"><img  src="../assets/vectors/huge_iconinterfaceoutlinehome_044_x2.svg" style="width: 60%;
